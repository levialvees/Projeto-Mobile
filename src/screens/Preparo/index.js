    ...
    return (
      ...
      <SafeAreaView>
        ...
        <View style={styles.container}>
          ...
          <Pressable style={styles.textButton} onPress={()=>{ alert ('Pedido esta sendo preparado aguardem');}}>
          <Text style={styles.textButton}>Preparar Pedido</Text>
          </Pressable>
          </TouchableOpacity> 
          <TouchableOpacity style={styles.Voltar}  onPress={() => navigation.goBack('Preparo')}>
